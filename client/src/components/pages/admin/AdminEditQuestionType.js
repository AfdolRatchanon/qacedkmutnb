...
//fucntions
import { adminReadQuestionType, adminUpdateQuestionType } from "../../functions/admin";
               ...
               <div className="row mb-2">
                  ...
                  <div className="col-sm-6">
                     <ol className="breadcrumb float-sm-right">
                        ...
                        <li className="breadcrumb-item font-weight-bold">แก้ไขหมวดคำถาม</li>
                     </ol>
                  </div>
               </div>
            </div>
                           ...
                           {editValue.map((value, key) => (
                              <form key={key} onSubmit={handleSubmit}>
                                 <div className="form-group row">
                                    ...
                                    <label className="col-sm-3">ระดับการเข้าถึงข้อมูล</label>
                                    <input
                                       type="text"
